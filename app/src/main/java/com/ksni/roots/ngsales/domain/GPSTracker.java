...
public class GPSTracker extends Service implements LocationListener {
    ...
    private void updateLoc(){
        SharedPreferences session =mContext.getSharedPreferences("ngsales", 0);
        ...
        Synchronous syn = new Synchronous( mContext, db.database(), company,sls);
        syn.postGPS(String.valueOf(getLatitude()),String.valueOf(getLongitude()));
