 ...
 */
public class DiscountExtByOutlet {
    final static String TABLE = "sls_discount_ext_outlet";
    ...
    public DiscountExtByOutlet(SQLiteDatabase db){
        outlet_id= "";
        product_id= "";
        discount = 0;
        this.db = db;
