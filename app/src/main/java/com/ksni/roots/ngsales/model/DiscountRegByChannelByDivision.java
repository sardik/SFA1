 ...
 */
public class DiscountRegByChannelByDivision {
    final static String TABLE = "sls_discount_reg_channel_division";
    ...
    public DiscountRegByChannelByDivision(SQLiteDatabase db){
        channel= "";
        division= "";
        discount = 0;
        this.db = db;
